...
class MockContextInfusedNodeGenerator:
    ...
    async def generate_trunk_node(
        ...
        """
        logger.info("Mock: Generating trunk node for testing")
    ...
    async def generate_branch_from_parent(
        ...
        """
        logger.info("Mock: Generating branch nodes for testing")
    ...
    async def generate_micro_actions(
        ...
        for i in range(count):
            action = HTANodeModel(
                ...
                description="A small, achievable action to make progress",
                status="pending",
                created_at=datetime.now(timezone.utc),
                updated_at=datetime.now(timezone.utc),
                is_leaf=True,
